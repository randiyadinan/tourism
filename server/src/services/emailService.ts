...
export interface SendCustomerConfirmationParams {
  to: string;
  name: string;
  bookingCode: string;
  tourTitle: string;
...
export interface SendAdminPaymentNotificationParams {
  bookingCode: string;
  customerName: string;
  customerEmail: string;
  paymentId: string;
...
export class EmailService {
  private getResendClient(): { resend: Resend; fromEmail: string; adminEmail: string } {
