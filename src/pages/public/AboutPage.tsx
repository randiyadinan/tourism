...
export const AboutPage: React.FC = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      bio: 'Specialist in luxury tea country bungalows, boutique coastal villas, and private wildlife safaris.'
    },
    {
      name: 'Roshan Silva',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-3">
          ...
          <p className="text-sm sm:text-base text-[#68736E] leading-relaxed">
            Sharing the UNESCO heritage, turquoise coastlines, and warm island hospitality of Sri Lanka with care, comfort, and local authenticity.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="relative h-[420px] rounded-3xl overflow-hidden shadow-xl">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#075E63]/90 via-transparent to-transparent" />
            <div className="absolute bottom-6 left-6 right-6 text-white p-5 bg-[#075E63]/60 backdrop-blur-md rounded-2xl border border-white/20">
          ...
          <div className="space-y-4 text-xs sm:text-sm text-[#68736E] leading-relaxed">
            <h2 className="font-serif text-2xl sm:text-3xl font-normal text-[#173238] leading-snug">
            ...
            <p>
              From private wildlife safaris in Yala and tea country hikes in Ella to peaceful boutique retreats in Galle Fort and Mirissa, every detail is handled by your dedicated concierge.
            </p>

            <div className="grid grid-cols-2 gap-4 pt-3 text-[#173238]">
              <div className="p-4 bg-white rounded-2xl border border-stone-200 shadow-xs">
                <span className="font-serif text-2xl font-bold text-[#075E63] block">10+</span>
                <span className="text-xs text-[#68736E] font-medium">Years Experience</span>
              </div>
              <div className="p-4 bg-white rounded-2xl border border-stone-200 shadow-xs">
                <span className="font-serif text-2xl font-bold text-[#075E63] block">100%</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white/85 backdrop-blur-xl p-7 rounded-3xl border border-white/80 shadow-xs space-y-3">
            <div className="w-11 h-11 rounded-2xl bg-[#075E63] text-[#DDF5F0] flex items-center justify-center">
              <Award className="w-5 h-5" />
            </div>
            <h3 className="font-serif text-lg font-bold text-[#173238]">Certified Chauffeurs</h3>
          ...
          <div className="bg-white/85 backdrop-blur-xl p-7 rounded-3xl border border-white/80 shadow-xs space-y-3">
            <div className="w-11 h-11 rounded-2xl bg-[#0B7A75] text-white flex items-center justify-center">
              <TreePine className="w-5 h-5" />
            </div>
            <h3 className="font-serif text-lg font-bold text-[#173238]">Sustainable Travel</h3>
            <p className="text-xs sm:text-sm text-[#68736E] leading-relaxed">
          ...
          <div className="bg-white/85 backdrop-blur-xl p-7 rounded-3xl border border-white/80 shadow-xs space-y-3">
            <div className="w-11 h-11 rounded-2xl bg-[#075E63] text-[#55C7C1] flex items-center justify-center">
              <ShieldCheck className="w-5 h-5" />
            </div>
            <h3 className="font-serif text-lg font-bold text-[#173238]">Transparent Pricing</h3>
            <p className="text-xs sm:text-sm text-[#68736E] leading-relaxed">
        ...
        <div className="space-y-8">
          <div className="text-center max-w-xl mx-auto space-y-2">
            <h2 className="font-serif text-2xl sm:text-3xl font-normal text-[#173238]">Our Experience Team</h2>
            ...
            {teamMembers.map((member, i) => (
              <div key={i} className="bg-white rounded-3xl overflow-hidden border border-stone-200 shadow-xs flex flex-col">
                ...
                <div className="p-6 space-y-2 flex-1 flex flex-col justify-between">
                  <div>
                    <h3 className="font-serif text-lg font-bold text-[#173238]">{member.name}</h3>
                    <span className="text-xs font-semibold text-[#0B7A75] block">{member.role}</span>
