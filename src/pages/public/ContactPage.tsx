  ...
  const faqs = [
    {
      ...
      a: 'We recommend booking 2 to 4 months in advance, especially for high season (December through April) to secure the finest boutique tea bungalows and scenic blue train observation tickets.'
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="bg-white/85 backdrop-blur-xl p-7 rounded-3xl border border-white/80 shadow-[0_4px_20px_-4px_rgba(6,44,34,0.06)] space-y-4">
              <h2 className="font-serif text-xl font-bold text-[#17231F]">Direct Channels</h2>

              <div className="space-y-3 text-xs sm:text-sm text-[#68736E]">
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-xl bg-[#0B3D2E] text-[#DDEFE8] flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-semibold text-[#17231F] block">Concierge Email</span>
                    <a href="mailto:concierge@lankavoyage.com" className="hover:text-[#176B52] transition-colors">concierge@lankavoyage.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-semibold text-[#17231F] block">Support Hours</span>
            ...
            {/* Quick WhatsApp Card in Deep Forest Green */}
          ...
          <div className="lg:col-span-7 bg-white/85 backdrop-blur-xl p-7 sm:p-9 rounded-3xl border border-white/80 shadow-[0_4px_20px_-4px_rgba(6,44,34,0.06)] space-y-6">
            <div>
              <h2 className="font-serif text-2xl font-bold text-[#17231F]">Send an Inquiry</h2>
              <p className="text-xs text-[#68736E] mt-1">We typically reply within 2 to 4 hours.</p>
            </div>

            {submitted ? (
              <div className="p-8 text-center bg-[#DDEFE8]/60 rounded-2xl border border-[#176B52]/30 space-y-3">
                <CheckCircle2 className="w-10 h-10 text-[#176B52] mx-auto" />
                <h3 className="font-serif text-xl font-bold text-[#17231F]">Inquiry Received</h3>
                ...
                <button
                  ...
                  className="mt-2 text-xs font-semibold text-[#176B52] hover:underline"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-xs sm:text-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="font-semibold text-[#17231F]">Full Name *</label>
                    <input
                      type="text"
                      required
                      value={name}
                ...
                <div className="space-y-1">
                  <label className="font-semibold text-[#17231F]">Your Message / Travel Vision *</label>
                  <textarea
                    required
                    rows={4}
                    value={message}
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 bg-[#0B3D2E] hover:bg-[#176B52] text-white font-semibold text-xs sm:text-sm rounded-xl transition-all flex items-center justify-center gap-2 shadow-sm border border-white/20"
                >
                  <Send className="w-4 h-4 text-[#DDEFE8]" />
        ...
        {/* FAQs */}
        <div className="bg-white/85 backdrop-blur-xl rounded-3xl p-7 sm:p-9 border border-white/80 shadow-[0_4px_20px_-4px_rgba(6,44,34,0.06)] space-y-4 max-w-4xl mx-auto">
          <h2 className="font-serif text-2xl font-bold text-[#17231F] text-center">Frequently Asked Questions</h2>
