  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="font-serif text-2xl sm:text-3xl font-bold text-[#062C22]">Notification & Broadcast Center</h1>
      ...
      <div className="bg-white rounded-3xl border border-stone-200 p-6 shadow-sm space-y-4">
        <h3 className="font-serif font-bold text-base text-[#062C22]">Dispatched Announcements</h3>
              ...
              >
                ...
                <div className="flex-1 space-y-1">
                  <div className="flex items-center justify-between">
                    <h4 className="font-bold text-xs text-[#062C22]">{notif.title}</h4>
                  ...
                  <div className="flex items-center gap-3 pt-1 text-[10px] text-stone-400">
                    <span className="flex items-center gap-1 font-semibold text-[#176B52]">
        ...
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4 backdrop-blur-xs">
          <div className="bg-white w-full max-w-lg rounded-3xl p-6 sm:p-8 shadow-2xl border border-stone-200 space-y-6">
            <div className="flex items-center justify-between border-b border-stone-100 pb-4">
              <h3 className="font-serif text-xl font-bold text-[#062C22]">Create Announcement / Alert</h3>
              <button
            ...
            <form onSubmit={handleSendNotification} className="space-y-4 text-xs">
              <div className="space-y-1">
                <label className="font-bold text-[#062C22]">Target Recipient</label>
                <select
                  value={targetUser}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="font-bold text-[#062C22]">Notification Type</label>
                  <select
                    value={type}
                ...
                <div className="space-y-1">
                  <label className="font-bold text-[#062C22]">Target Link (Optional)</label>
                  <input
                    type="text"
                    value={linkUrl}
              ...
              <div className="space-y-1">
                <label className="font-bold text-[#062C22]">Title</label>
                <input
                  type="text"
                  required
                  value={title}
              ...
              <div className="space-y-1">
                <label className="font-bold text-[#062C22]">Message Content</label>
                <textarea
                  required
                  rows={3}
                  value={message}
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-stone-100">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-[#0B3D2E] text-white font-bold rounded-xl hover:bg-[#134E3F] inline-flex items-center gap-1.5"
                >
