    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSave} className="bg-white p-8 sm:p-10 rounded-3xl border border-stone-200 shadow-sm space-y-8 text-xs">
        ...
        <div className="border-b border-stone-100 pb-4">
          <h2 className="font-serif text-2xl font-bold text-[#082F24]">
        ...
        <div className="space-y-4">
          <h3 className="font-serif font-bold text-sm text-[#082F24] uppercase tracking-wider">General Information</h3>
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full bg-[#FAF8F5] border border-stone-300 rounded-xl px-3.5 py-2 text-xs text-[#082F24]"
            />
          </div>
        ...
        <div className="space-y-4 pt-4 border-t border-stone-100">
          <div className="flex items-center justify-between">
            <h3 className="font-serif font-bold text-sm text-[#082F24] uppercase tracking-wider">
              Day-by-Day Itinerary Schedule ({itinerary.length} Days)
            </h3>
            <button
              type="button"
              onClick={handleAddDay}
              className="inline-flex items-center gap-1 px-3 py-1.5 bg-[#0D3B2E] text-white font-bold rounded-lg text-xs"
            >
          ...
          <div className="space-y-4">
            {itinerary.map((day, idx) => (
              <div key={idx} className="bg-[#FAF8F5] p-5 rounded-2xl border border-stone-200 space-y-3">
                <div className="flex items-center justify-between">
                  <span className="font-bold text-[#8C6D2B]">Day {day.day}</span>
                  {itinerary.length > 1 && (
                    <button
                      type="button"
        ...
        <div className="flex items-center gap-6 pt-4 border-t border-stone-100">
          <label className="flex items-center gap-2 cursor-pointer font-bold text-stone-700">
            <input
              ...
              className="w-4 h-4 accent-[#0D3B2E]"
            />
        ...
        <div className="pt-4 border-t border-stone-100 flex justify-end">
          <button
            type="submit"
            className="inline-flex items-center gap-2 px-7 py-3 bg-[#0D3B2E] text-white hover:bg-[#134E3F] font-bold text-xs rounded-xl shadow-md transition-all"
          >
