  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="font-serif text-2xl sm:text-3xl font-bold text-[#082F24]">System Infrastructure & Settings</h1>
        ...
        <button
          ...
          disabled={testingDb}
          className="inline-flex items-center gap-1.5 px-4 py-2.5 bg-[#0D3B2E] text-white hover:bg-[#134E3F] text-xs font-bold rounded-xl shadow-sm transition-all disabled:opacity-50"
        >
          <Server className="w-4 h-4 text-[#E5C378]" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl border border-stone-200 shadow-sm space-y-4">
          <div className="flex items-center gap-2 border-b border-stone-100 pb-3">
            <Globe className="w-5 h-5 text-[#0D3B2E]" />
            <h3 className="font-serif font-bold text-base text-[#082F24]">Application Environments</h3>
          </div>

          <div className="space-y-3 text-xs">
            <div className="flex justify-between py-1 border-b border-stone-100">
              <span className="text-stone-500">Frontend Domain:</span>
              <strong className="text-[#082F24]">https://tourism-swart-seven.vercel.app</strong>
            </div>
            <div className="flex justify-between py-1 border-b border-stone-100">
              <span className="text-stone-500">Backend API URL:</span>
              <strong className="text-[#082F24] truncate max-w-[220px]">https://lankavoyage-api.lankavoyage.workers.dev</strong>
            </div>
            <div className="flex justify-between py-1 border-b border-stone-100">
        ...
        <div className="bg-white p-6 rounded-3xl border border-stone-200 shadow-sm space-y-4">
          <div className="flex items-center gap-2 border-b border-stone-100 pb-3">
            ...
            <h3 className="font-serif font-bold text-base text-[#082F24]">Database Architecture</h3>
          </div>

          <div className="space-y-3 text-xs">
            <div className="flex justify-between py-1 border-b border-stone-100">
              <span className="text-stone-500">Provider:</span>
              <strong className="text-[#082F24]">Neon PostgreSQL Serverless</strong>
            </div>
            <div className="flex justify-between py-1 border-b border-stone-100">
              <span className="text-stone-500">ORM / Client:</span>
              <span className="font-semibold text-[#082F24]">Prisma Client v6.19</span>
            </div>
            <div className="flex justify-between py-1 border-b border-stone-100">
        ...
        <div className="bg-white p-6 rounded-3xl border border-stone-200 shadow-sm space-y-4">
          <div className="flex items-center gap-2 border-b border-stone-100 pb-3">
            <CreditCard className="w-5 h-5 text-[#0D3B2E]" />
            <h3 className="font-serif font-bold text-base text-[#082F24]">PayHere Payment Gateway</h3>
          </div>
          ...
          <div className="space-y-3 text-xs">
            ...
            <div className="flex justify-between py-1 border-b border-stone-100">
              ...
              <strong className="text-[#082F24]">1237709</strong>
            </div>
            <div className="flex justify-between py-1 border-b border-stone-100">
            ...
            <div className="flex justify-between py-1">
              ...
              <strong className="text-[#082F24]">USD ($)</strong>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-stone-200 shadow-sm space-y-4">
          <div className="flex items-center gap-2 border-b border-stone-100 pb-3">
            ...
            <h3 className="font-serif font-bold text-base text-[#082F24]">Access Control & Security</h3>
          </div>

          <div className="space-y-3 text-xs">
            <div className="flex justify-between py-1 border-b border-stone-100">
              <span className="text-stone-500">Current Operator:</span>
              <strong className="text-[#082F24]">{user?.name} ({user?.email})</strong>
            </div>
            <div className="flex justify-between py-1 border-b border-stone-100">
