    ...
    <section className="py-20 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-[#C5A059]/15 text-[#8C6D2B] text-xs font-bold uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          {steps.map((step, idx) => {
            ...
            return (
              <div key={idx} className="relative bg-[#FAF8F5] rounded-2xl p-7 border border-stone-200 shadow-sm flex flex-col justify-between">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="font-serif text-3xl font-bold text-[#C5A059] opacity-70">
                      {step.step}
                    </span>
                    <div className="w-12 h-12 rounded-xl bg-[#0D3B2E] text-[#E5C378] flex items-center justify-center shadow-md">
                ...
                <div className="pt-4 mt-6 border-t border-stone-200/60 text-xs font-semibold text-[#0D3B2E]">
                  Step {idx + 1} of 4
                </div>
              </div>
            );
        ...
        <div className="mt-14 text-center">
          <Link
            to="/customize"
            className="inline-flex items-center gap-2 px-8 py-4 bg-[#0D3B2E] text-white hover:bg-[#134E3F] text-base font-bold rounded-xl shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-0.5"
          >
