...
export const TripPlannerBar: React.FC = () => {
  ...
  return (
    <div className="bg-white/85 backdrop-blur-2xl rounded-3xl shadow-[0_20px_50px_-15px_rgba(6,44,34,0.14)] border border-white/90 p-5 sm:p-7 text-[#17231F]">
      <form onSubmit={handleSearch} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
        ...
        <div className="space-y-1.5">
          ...
          <select
            ...
            className="w-full bg-[#F8F7F2]/85 border border-stone-200 rounded-xl px-3.5 py-2.5 text-xs sm:text-sm font-medium text-[#17231F] focus:outline-none focus:ring-2 focus:ring-[#176B52] transition-colors"
          >
