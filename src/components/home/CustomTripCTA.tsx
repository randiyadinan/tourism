...
import { ArrowRight, Check, MapPin, Hotel, Car } from 'lucide-react';

export const CustomTripCTA: React.FC = () => {
  return (
    <section className="py-20 sm:py-28 relative overflow-hidden bg-[#075E63] text-white">
      {/* Background Scenic Landscape Texture */}
      <div className="absolute inset-0 z-0 opacity-20">
        <img
          src="https://images.unsplash.com/photo-1586861635167-e5223aadc9fe?auto=format&fit=crop&w=2000&q=85"
          alt="Sri Lanka Nature & Landscapes"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#075E63] via-[#075E63]/90 to-transparent" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 text-[#DDF5F0] text-xs font-semibold uppercase tracking-wider">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-normal leading-tight">
              ...
              <span className="text-[#DDF5F0] italic">Starts Here.</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1 text-xs sm:text-sm text-stone-200">
              <div className="flex items-center gap-2.5">
                <div className="w-5 h-5 rounded-full bg-[#0B7A75] flex items-center justify-center text-[#DDF5F0] shrink-0">
            ...
            <div className="pt-3">
              <Link
                to="/customize"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-[#0B7A75] hover:bg-[#064e52] text-white font-semibold text-sm transition-all border border-white/20 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
              >
          ...
          <div className="lg:col-span-5">
            <div className="bg-white/10 backdrop-blur-2xl rounded-3xl p-7 sm:p-8 border border-white/20 space-y-4 shadow-2xl">
              <div className="flex items-center justify-between border-b border-white/15 pb-3.5">
                <div>
                  <span className="text-[11px] text-[#E98B6B] uppercase tracking-wider block font-semibold">Sample Custom Itinerary</span>
                  <span className="font-serif text-xl font-bold text-white">Classic Ceylon Odyssey</span>
                </div>
                <span className="px-3 py-1 rounded-full text-xs font-bold bg-[#0B7A75] text-white border border-white/20">
                  10 Days
                </span>
              </div>
              ...
              <div className="space-y-3 text-xs sm:text-sm text-stone-200">
                <div className="flex items-center gap-3 bg-black/20 p-3.5 rounded-2xl border border-white/10">
                  <MapPin className="w-4 h-4 text-[#55C7C1] shrink-0" />
                  <span>Sigiriya &bull; Kandy &bull; Nuwara Eliya &bull; Yala Safari &bull; Galle</span>
                </div>
                <div className="flex items-center gap-3 bg-black/20 p-3.5 rounded-2xl border border-white/10">
                  <Car className="w-4 h-4 text-[#55C7C1] shrink-0" />
                  <span>Private Air-Conditioned Sedan + Chauffeur Guide</span>
                </div>
                <div className="flex items-center gap-3 bg-black/20 p-3.5 rounded-2xl border border-white/10">
                  <Hotel className="w-4 h-4 text-[#55C7C1] shrink-0" />
